...
var KompilatKombinat = (window.KompilatKombinat || (function() {
  ...
  var public_api = {
    ...
    /** log level helpers */
    log:  function(msg, prefix) { _log('info',  msg, prefix); },
    dbg:  function(msg, prefix) { _log('debug', msg, prefix); },
    err:  function(msg, prefix) { _log('error', msg, prefix); },
    warn: function(msg, prefix) { _log('warn',  msg, prefix); },
    ...
    autoPopulate:function() {
      ...
      $$('.'+_sInputClass).each(function(oInput) {
        ...
        Event.observe(oInput, 'blur', function() {
          ...
          if (!this.value.length) { this.value = kk.getLabel(this).innerHTML;
