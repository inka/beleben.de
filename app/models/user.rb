...
class User < ActiveRecord::Base
  ...
  has_many :log_entries, :dependent => :delete_all do
    def today_count
      count :conditions => LogEntry.created_at_today
    end
    def today
      find :all, :conditions => LogEntry.created_at_today
    end
  end
  ...
  has_many :kontakts, :dependent => :delete_all
